...
public class P056_PowerfulDigitSum {
  int powerfulDigitSum() {
    ...
    for(int base = 1; base <= 99; base += 1) {
    	for(int exponent = 1; exponent <= 99; exponent += 1) {
  ...
  public void testP056_PowerfulDigitSum() {
	  P056_PowerfulDigitSum pds = new P056_PowerfulDigitSum();
	  int result = pds.powerfulDigitSum();
